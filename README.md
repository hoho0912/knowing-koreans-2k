...
→ https://hoho0912.github.io/knowing-koreans-2k/results/

페이지에는 ⑤ 본 라운드 N=1,000 측정의 발견 패턴, axis별 분포, 인용 응답 카드, 큐레이터용 후속 질문이 4섹션 보고서 형식으로 들어간다. 원시 데이터를 처음 만나는 사용자가 먼저 들르는 입구 페이지 역할이다.
